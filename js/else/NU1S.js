...
str.addEventListener('click', function () {
    if (str.checked) { neob.style.display = "none"; tt.style.display = "block"; tt.innerHTML = "Струн столько же сколько укулеле"; }
...
but.addEventListener('click', function () {
    ...
    if (schet > 1) { text += schet + ' укулеле по 420руб. '; numb += 420 * schet + 'руб.(за укулеле) '; first = 420 * schet; }
    else { text += '1 укулеле по 420руб. '; numb += 420 + 'руб.(за укулеле) '; first = 420; }

    if (str.checked) { text += '+ ' + schet + ' пачек струн по 30руб. '; numb += '+ ' + 30 * schet + 'руб.(за струны) '; second = 30 * schet; }
    else {
        if (strun > 0) { text += '+ ' + strun + ' пачек струн по 30руб. '; numb += '+ ' + 30 * strun + 'руб.(за струны) '; second = 30 * strun; }
        else { text += '+ без струн '; }
    }
