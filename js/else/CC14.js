...
but.addEventListener('click', function () {
    ...
    if (schet > 1) { text += schet + ' виалончелей по 570руб. '; numb += 570 * schet + 'руб.(за виалончель) '; first = 570 * schet; }
    else { text += '1 виалончель по 570руб. '; numb += 570 + 'руб.(за виалончель) '; first = 570; }
