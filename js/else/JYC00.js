...
but.addEventListener('click', function () {
    ...
    if (schet > 1) { text += schet + ' виалончелей по 500руб. '; numb += 500 * schet + 'руб.(за виалончель) '; first = 500 * schet; }
    else { text += '1 виалончель по 500руб. '; numb += 500 + 'руб.(за виалончель) '; first = 500; }
