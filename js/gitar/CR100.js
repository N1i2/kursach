...
but.addEventListener('click', function () {
    ...
    if (schet > 1) { text += schet + ' гитары по 650руб. '; numb += 650 * schet + 'руб.(за гитары) '; first = 650 * schet; }
    else { text += '1 гитара по 650руб. '; numb += 650 + 'руб.(за гитару) '; first = 650; }

    if (str.checked) { text += '+ ' + schet + ' пачек струн по 50руб. '; numb += '+ ' + 50 * schet + 'руб.(за струны) '; second = 50 * schet; }
    else {
        if (strun > 0) { text += '+ ' + strun + ' пачек струн по 50руб. '; numb += '+ ' + 50 * strun + 'руб.(за струны) '; second = 50 * strun; }
        else { text += '+ без струн '; }
    }
